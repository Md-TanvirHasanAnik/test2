            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @if(Auth::guard()->guest()||!Auth::guard('admin')->check())
                        ...
                        @else
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.semesters') }}">{{ __('Semesters') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.timeSlots') }}">{{ __('Time Slots') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.control') }}">{{ __('App Control') }}</a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link" href="{{ route('admin.profile') }}">{{ __('Profile') }}</a>
                            </li>
