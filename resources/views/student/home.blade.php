                    ...
                    <div class="card-body table-responsive-md p-0">
                        <table class="table">
                            ...
                            @foreach($appointments as $appointment)
                                <tr>
                                    <td class="td-image">
                                        <a href="{{url("/faculty/$appointment->s_id")}}" data-toggle="tooltip" data-original-title="{{$appointment->name}}"><img src="{{$appointment->photo}}" class="border img-bordered-sm img-size-50 img-circle"  ></a>
                                    </td>
                                    <td>
