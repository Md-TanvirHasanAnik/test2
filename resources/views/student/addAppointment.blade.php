            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div id="form" class="form-area" style="clear:right;">
                        <form action="{{route('appointment.store')}}" id="appointmentForm" method="post" autocomplete="off" accept-charset="utf-8">
                            @csrf
                            <div class="form-padding" >
                                ...
                                <div class="form-group">
                                   ...
                                   <div class="input-group">
                                    ...
                                    <input name="starts_at" autocomplete="off" type="text" class="form-control" id="starts_at" placeholder="Time" value="">
                                       </div>
                                    <div class="input-group-addon">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div id="end_time_div">
                                        <input name="ends_at" autocomplete="off" type="text" class="form-control" id="ends_at" placeholder="Time" value="">
                                        </div>
                                            <div class="input-group-addon">
                                            <span><i class="far fa-clock"></i></span>
                                        </div>
