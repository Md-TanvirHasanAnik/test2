                        ...
                        <table class="table">
                            ...
                            @foreach($appointments as $appointment)
                                <tr>
                                    ...
                                    <td class="td-action">
                                        <br><br><a href="javascript:;"  class="btn btn-rounded btn-outline-dark btn-sm send-reminder"><i class="fa fa-send"></i>Edit</a>
                                        <br><br><a href="javascript:;"  class="btn btn-rounded btn-outline-dark btn-sm send-reminder"><i class="fa fa-send"></i>Cancel</a>
                                        <br><br><a href="javascript:;"  class="btn btn-rounded btn-outline-dark btn-sm send-reminder"><i class="fa fa-send"></i>Delete</a>
                                    </td>
                                </tr>
                            @endforeach
